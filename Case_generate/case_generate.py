...
from common.writeExcel import WriteExcel  # 写入excel模块
from common.logger import Log  # 打印日志模块
from common.processingJson import write_data  # 写入json文件模块
from common.difference import diff_excel, diff_json
from common import read_config

sys.path.append(r'D:\Tester\Scripts')
...
class AnalysisJson:
    ...
    def __init__(self, url_json):
        ...
        r = requests.get(self.url_json + '/v2/api-docs?group=供应商管理').json()
        # print(r)
